...
```csharp
public class MText : DotMarkdown.Linq.MElement
```

### Inheritance

[Object](https://docs.microsoft.com/en-us/dotnet/api/system.object) &#x2192; [MObject](../MObject/README.md) &#x2192; [MElement](../MElement/README.md) &#x2192; MText

## Constructors

| Constructor | Summary |
| ----------- | ------- |
| [MText(MText)](-ctor/README.md#DotMarkdown_Linq_MText__ctor_DotMarkdown_Linq_MText_) | |
| [MText(String)](-ctor/README.md#DotMarkdown_Linq_MText__ctor_System_String_) | |
