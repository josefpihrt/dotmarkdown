...
```csharp
public class MCharEntity : DotMarkdown.Linq.MElement
```

### Inheritance

[Object](https://docs.microsoft.com/en-us/dotnet/api/system.object) &#x2192; [MObject](../MObject/README.md) &#x2192; [MElement](../MElement/README.md) &#x2192; MCharEntity

## Constructors

| Constructor | Summary |
| ----------- | ------- |
| [MCharEntity(Char)](-ctor/README.md#DotMarkdown_Linq_MCharEntity__ctor_System_Char_) | |
| [MCharEntity(MCharEntity)](-ctor/README.md#DotMarkdown_Linq_MCharEntity__ctor_DotMarkdown_Linq_MCharEntity_) | |
