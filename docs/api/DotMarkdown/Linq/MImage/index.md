...
```csharp
public class MImage : DotMarkdown.Linq.MElement
```

### Inheritance

[Object](https://docs.microsoft.com/en-us/dotnet/api/system.object) &#x2192; [MObject](../MObject/index.md) &#x2192; [MElement](../MElement/index.md) &#x2192; MImage

## Constructors

| Constructor | Summary |
| ----------- | ------- |
| [MImage(MImage)](-ctor/index.md#DotMarkdown_Linq_MImage__ctor_DotMarkdown_Linq_MImage_) | |
| [MImage(String, String, String)](-ctor/index.md#DotMarkdown_Linq_MImage__ctor_System_String_System_String_System_String_) | |
