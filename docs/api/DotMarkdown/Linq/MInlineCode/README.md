...
```csharp
public class MInlineCode : DotMarkdown.Linq.MElement
```

### Inheritance

[Object](https://docs.microsoft.com/en-us/dotnet/api/system.object) &#x2192; [MObject](../MObject/README.md) &#x2192; [MElement](../MElement/README.md) &#x2192; MInlineCode

## Constructors

| Constructor | Summary |
| ----------- | ------- |
| [MInlineCode(MInlineCode)](-ctor/README.md#DotMarkdown_Linq_MInlineCode__ctor_DotMarkdown_Linq_MInlineCode_) | |
| [MInlineCode(String)](-ctor/README.md#DotMarkdown_Linq_MInlineCode__ctor_System_String_) | |
