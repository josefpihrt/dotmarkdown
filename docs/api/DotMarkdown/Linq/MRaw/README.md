...
```csharp
public class MRaw : DotMarkdown.Linq.MElement
```

### Inheritance

[Object](https://docs.microsoft.com/en-us/dotnet/api/system.object) &#x2192; [MObject](../MObject/README.md) &#x2192; [MElement](../MElement/README.md) &#x2192; MRaw

## Constructors

| Constructor | Summary |
| ----------- | ------- |
| [MRaw(MRaw)](-ctor/README.md#DotMarkdown_Linq_MRaw__ctor_DotMarkdown_Linq_MRaw_) | |
| [MRaw(String)](-ctor/README.md#DotMarkdown_Linq_MRaw__ctor_System_String_) | |
